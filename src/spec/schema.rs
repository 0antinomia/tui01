...
impl FieldSpec {
    ...
    pub fn action_button(label: impl Into<String>, button_label: impl Into<String>) -> Self {
        Self {
            id: None,
            label: label.into(),
            control: ControlSpec::ActionButton { label: button_label.into() },
            height_units: 1,
            operation: None,
        }
    }
    ...
    pub fn refresh_button(label: impl Into<String>, button_label: impl Into<String>) -> Self {
        Self {
            id: None,
            label: label.into(),
            control: ControlSpec::RefreshButton { label: button_label.into() },
            height_units: 1,
            operation: None,
        }
    }
    ...
    pub fn static_data(label: impl Into<String>, value: impl Into<String>) -> Self {
        Self {
            id: None,
            label: label.into(),
            control: ControlSpec::StaticData { value: value.into() },
            height_units: 1,
            operation: None,
        }
    }
    ...
    pub fn dynamic_data(label: impl Into<String>, value: impl Into<String>) -> Self {
        Self {
            id: None,
            label: label.into(),
            control: ControlSpec::DynamicData { value: value.into() },
            height_units: 1,
            operation: None,
        }
    }
    ...
    pub fn custom(label: impl Into<String>, control_name: impl Into<String>) -> Self {
        Self {
            id: None,
            label: label.into(),
            control: ControlSpec::Custom { control_name: control_name.into() },
            height_units: 1,
            operation: None,
        }
    }
    ...
    pub fn with_log_tail_lines(mut self, tail_lines: usize) -> Self {
        if let ControlSpec::LogOutput { tail_lines: slot, .. } = &mut self.control {
    ...
    pub fn with_operation_success(mut self, duration_ms: u64) -> Self {
        let target = self.operation.as_ref().and_then(|binding| binding.result_target.clone());
        self.operation =
    ...
    pub fn with_result_target(mut self, target_id: impl Into<String>) -> Self {
        ...
        let binding = self.operation.get_or_insert_with(|| OperationBinding::shell("true"));
...
mod tests {
    ...
    fn page_spec_materializes_runtime_blueprint() {
        let page =
            PageSpec::new("Workspace").with_sections(vec![SectionSpec::new("运行").with_fields(
                vec![
        ...
        assert_eq!(runtime.sections[0].fields[0].id.as_deref(), Some("project_name"));
